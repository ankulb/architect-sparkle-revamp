...
export const expertiseGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Commercial", to: "/expertise/commercial" },
      { label: "Data Centres", to: "/expertise/data-centres" },
      { label: "Transit Infra", to: "/expertise/transit-infrastructure" },
      { label: "Mixed Use", to: "/expertise/mixed-use" },
      { label: "Luxury Housing and Residential", to: "/expertise/luxury-housing-residential" },
      { label: "Hospitality", to: "/expertise/hospitality" },
...
export const projects = [
  ...
  { title: "Commercial Office Buildings", category: "Commercial & Institutional", image: congoHomeImage.url, to: "/portfolio/commercial-office-building" },
